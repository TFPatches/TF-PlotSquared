...
public enum C {
    ...
    NO_SCHEMATIC_PERMISSION("$2You don't have the permission required to use schematic $1%s",
        "Permission"), NO_PERMISSION("$2You do not have permission to do that.", "Permission"),

    NO_PERMISSION_EVENT("$2You do not have permission to do that.", "Permission"), NO_PLOT_PERMS(
    ...
    GRANTED_PLOTS("$1Result: $2%s $1grants left", "Grants"), GRANTED_PLOT(
        "$1%s0 $2now has $1%s1 $2granted plots", "Grants"),
